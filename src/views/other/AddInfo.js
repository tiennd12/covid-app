                    ...
                    <Stack>
                      <Grid container sx={{ textAlign: "center" }}>
                        <Grid item>
                          ...
                          times === "3 mũi" ? (
                            <Box
                              className={`${classes.box} ${classes.infected1}`}
                            >
                              <FormControl
                                variant="outlined"
                                sx={{ m: 1, minWidth: 200 }}
                              >
                                ...
                                <Select
                                  ...
                                  id="demo-simple-select"
                                  onChange={(e) =>
                                    setVaccineType1(e.target.value)
                                  }
                                  value={vaccineType1}
                                  sx={{ minWidth: 210 }}
                                >
                                  ...
                                  <MenuItem value="Nanocovax">
                                    Nanocovax
                                  </MenuItem>
                                  <MenuItem value="Pfizer-BioNTech">
                                    Pfizer-BioNTech
                                  </MenuItem>
                                  <MenuItem value="AstraZeneca">
                                    AstraZeneca
                                  </MenuItem>
                              ...
                              <TextField
                                ...
                                value={injectPerson1}
                                onChange={(e) =>
                                  setInjectPerson1(e.target.value)
                                }
                              />
                            </Box>
                          ) : (
                        ...
                        <Grid item>
                          {times === "2 mũi" || times === "3 mũi" ? (
                            <Box
                              className={`${classes.box} ${classes.infected2}`}
                            >
                              <FormControl
                                variant="outlined"
                                sx={{ m: 1, minWidth: 200 }}
                              >
                                ...
                                <Select
                                  ...
                                  id="demo-simple-select"
                                  onChange={(e) =>
                                    setVaccineType2(e.target.value)
                                  }
                                  value={vaccineType2}
                                  sx={{ minWidth: 210 }}
                                >
                              ...
                              <TextField
                                ...
                                value={injectPerson2}
                                onChange={(e) =>
                                  setInjectPerson2(e.target.value)
                                }
                              />
                            </Box>
                          ) : (
                        ...
                        <Grid item>
                          {times === "3 mũi" ? (
                            <Box
                              className={`${classes.box} ${classes.infected3}`}
                            >
                              <FormControl
                                variant="outlined"
                                sx={{ m: 1, minWidth: 200 }}
                              >
                                ...
                                <Select
                                  ...
                                  id="demo-simple-select"
                                  onChange={(e) =>
                                    setVaccineType3(e.target.value)
                                  }
                                  value={vaccineType3}
                                >
                                  <MenuItem value="" disabled>
                              ...
                              <TextField
                                ...
                                value={injectPerson3}
                                onChange={(e) =>
                                  setInjectPerson3(e.target.value)
                                }
                              />
                            </Box>
                          ) : (
